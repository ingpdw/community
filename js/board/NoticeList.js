  ...
  get(){
    ...
    list.then( ( data ) => {
			...
			this.$_node.slick({
				arrows: true,
				dots: true,
				prevArrow: '<button class="slick-arrow slick-prev"><i class="fe-icon-chevron_left"></i></button>',
				nextArrow: '<button class="slick-arrow slick-next"><i class="fe-icon-chevron_right"></i></button>',
				// autoplay: true,
				autoplaySpeed: 2500,
			});
